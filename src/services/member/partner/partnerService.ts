...
class PartnerService {
  public async create(body: any) {
    ...
    const res = await http.post('/api/services/app/Partners/CreatePartnerFull', body)
  ...
  public async update(body: any) {
    ...
    const res = await http.put('api/services/app/Partners/Update', body)
    notifySuccess(LNotification('SUCCESS'), LNotification('SAVING_SUCCESSFULLY'))
    return res.data.result
  }

  public async delete(id: number) {
    const res = await http.delete('api/services/app/Partners/Delete', { params: { id } })
    return res.data
  }

  public async activateOrDeactivate(id: number, isActive) {
    const res = await http.post('api/services/app/Partners/Active', { id }, { params: { isActive } })
  ...
  public async get(id: number): Promise<any> {
    ...
    const res = await http.get('api/services/app/Partners/Get', { params: { id } })
    if (res.data.result && res.data.result.birthDate) {
      res.data.result.birthDate = moment(res.data.result.birthDate)
    }
    return res.data.result
  ...
  public async getAll(params: any): Promise<PagedResultDto<any>> {
    const res = await http.get('api/services/app/Partners/GetAll', { params })
  ...
  public async getProjectRoles(params: any): Promise<any> {
    const res = await http.get('api/services/app/Partners/GetProjectRoles', { params })
    return res.data.result
  }

  public async setProjectRole(body: any) {
    const res = await http.post('api/services/app/Partners/SetProjectRoles', body)
    return res.data.result
  }
  public async getStaticInformation() {
    const res = await http.get('api/services/app/Partners/GetDashboard')
    return res.data.result
  }
