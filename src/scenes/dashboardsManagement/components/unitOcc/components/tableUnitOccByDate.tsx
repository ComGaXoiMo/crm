...
@observer
class TableUnitOccByDate extends AppComponentListBase<IProps> {
  ...
  getDashBoard = async () => {
    this.props.dashboardStore
      ...
      .finally(() => {
        this.dataAnalysis(
          this.props.dashboardStore.dashboardUnitOccDetailsDateData
        );
        this.setState({
          dataTable: this.props.dashboardStore.dashboardUnitOccDetailsDateData,
        });
      });
  };
...
export default withRouter(TableUnitOccByDate);
