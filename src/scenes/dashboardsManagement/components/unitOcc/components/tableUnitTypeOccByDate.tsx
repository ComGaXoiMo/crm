...
@observer
class TableUnitTypeOccByDate extends AppComponentListBase<IProps> {
  ...
  getDashBoard = async () => {
    this.props.dashboardStore
      ...
      .finally(() => {
        this.dataAnalysis(
          this.props.dashboardStore.dashboardUnitTypeOccDetailsDateData
        )
      })
  }
                  ...
                  return (
                    <>
                      ...
                      <tr>
                        ...
                        {unitType?.dataUnitType.map((item) => {
                          // const percent =
                          // const trueAvailable = project?.dataProject.find(
                          //   (item) =>
                          //     item.FormattedDateName ===
                          //       item.FormattedDateName &&
                          //     item.ProjectId === item.ProjectId
                          // )?.TotalAvailable
                          // const truePercent =
                          //   Math.round((item?.Leased * 10000) / trueAvailable) /
                          //   100
        ...
        <Spin spinning={this.props.dashboardStore.isLoading}>
          <div ref={this.printRef} className="dashboard-style">
            <Row gutter={[8, 8]}>
              ...
              <Col sm={{ span: 24, offset: 0 }}>
                <div className="table-contr" id="tblOccUnitTypeByDate">
                  {this.dataAnalysis(
                    this.props.dashboardStore
                      .dashboardUnitTypeOccDetailsDateData
                  )}
                </div>
              </Col>
            </Row>
...
export default withRouter(TableUnitTypeOccByDate)
