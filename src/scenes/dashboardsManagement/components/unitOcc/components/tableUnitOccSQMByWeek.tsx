...
@observer
class TableUnitOccSQMByWeek extends AppComponentListBase<IProps> {
  ...
  getDashBoard = async () => {
    this.props.dashboardStore
      ...
      .finally(() => {
        this.dataAnalysis(
          this.props.dashboardStore.dashboardUnitOccSQMDetailsWeekData
        )
        this.setState({
          dataTable:
            this.props.dashboardStore.dashboardUnitOccSQMDetailsWeekData,
...
export default withRouter(TableUnitOccSQMByWeek)
