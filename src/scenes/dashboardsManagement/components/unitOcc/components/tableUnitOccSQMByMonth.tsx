...
@observer
class TableUnitOccSQMByMonth extends AppComponentListBase<IProps> {
  ...
  getDashBoard = async () => {
    this.props.dashboardStore
      ...
      .finally(() => {
        this.dataAnalysis(
          this.props.dashboardStore.dashboardUnitOccSQMDetailsMonthData
        )
        this.setState({
          dataTable:
            this.props.dashboardStore.dashboardUnitOccSQMDetailsMonthData,
            ...
            <Row gutter={[8, 8]}>
              ...
              <Col sm={{ span: 24, offset: 0 }}>
                <div className="table-contr" id="tblOccUnitByMonth">
                  {this.dataAnalysis(
                    this.props.dashboardStore
                      .dashboardUnitOccSQMDetailsMonthData
                  )}
                </div>
              </Col>
            </Row>
...
export default withRouter(TableUnitOccSQMByMonth)
