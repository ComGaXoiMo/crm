...
export const globalPlugins: any = (additionPlugin?) => ({
  ...
  datalabels: {
    ...
    formatter: function (value) {
      return value < 1000000 ? value : Math.round(value / 1000000) + "M"
    },
  },
})
const IntensiveBarStaff = (props: Props) => {
  React.useEffect(() => {
  ...
  return (
    <>
      <Card>
        <strong>{L("INTENSIVE_BY_STAFF")}</strong>
        <Row gutter={[8, 8]}>
...
export default IntensiveBarStaff
