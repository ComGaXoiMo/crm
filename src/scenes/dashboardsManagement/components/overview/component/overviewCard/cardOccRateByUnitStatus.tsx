...
@observer
class CardOccRateByUnitStatus extends AppComponentListBase<IOverviewProps> {
          ...
          <Row gutter={[4, 4]}>
            <Col sm={{ span: 24 }}>
              <span className="card-overview-title">
                {this.L("OCCUPANCY_RATE_BY_UNIT_STATUS")}
              </span>
            </Col>
              ...
              <Row gutter={[24, 4]}>
                ...
                {this.props.dataThis?.map((item, index) => (
                  <>
                    ...
                    <Col sm={{ span: 8 }} className="card-text-right">
                      {formatNumber(dataLast[index]?.TotalUnit)}
                    </Col>
                    <Col sm={{ span: 8 }} className="card-text-right">
...
export default withRouter(CardOccRateByUnitStatus)
